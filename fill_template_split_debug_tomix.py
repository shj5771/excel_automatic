# 파일명: fill_template_split_debug_tomix.py
# 사용법: python fill_template_split_debug_tomix.py

### 엑셀 템플릿에 CSV 데이터를 채우고, 행 수에 따라 여러 파일로 분할 저장하는 스크립트 ###
### 추가: 전체 행을 무작위로 섞어서 저장하는 기능 포함 ###
import pandas as pd
...
output_dir    = Path(r"C:\Users\ST\Desktop\excel_program\output\unique_to_mix")
